...
public plugin_init() {
	register_plugin("Crab'sMapManager","1.6a","Head crab")
	register_cvar("crab_map_manager","1.6a",FCVAR_SPONLY|FCVAR_SERVER)
	...
	register_cvar("amx_mapvoteplayers","8")
